...
%%
save('data.mat','Final_Sub_Pull','Final_Sub_Pull_UG','Final_Sub_Pull_UCB','Final_Sub_Pull_BAI','Final_Sub_Pull_DETC'...
    ,'Regret_record','Regret_record_UG','Regret_record_UCB','Regret_record_BAI','Regret_record_DETC')
